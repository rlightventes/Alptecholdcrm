                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-sm-4 text-right m-b-30">
						    <a href="departmentsHide.php" class="btn btn-primary pull-right rounded" style="margin-left:10px"><i class="fa fa-eye-slash"></i> Hide</a>
							<a href="add-departments.php" class="btn btn-primary rounded" ><i class="fa fa-plus"></i> Add New Department</a>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
								...
								<table class="table table-striped custom-table m-b-0 datatable">
									...
									<tbody>
										<?php 
											...
											$getDepart = $mysqli->get(DEPARTMENT);
											...
											<td class="text-right">
												<div class="dropdown">
													...
													<ul class="dropdown-menu pull-right">
														<li><a href="add-departments.php?department=<?=$departVal['id']?>"  title="Edit"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content modal-md">
						...
						<form method="post" action="ajax.php?action=delete">
								...
								<input type="hidden" name="tab_name" value="<?=DEPARTMENT?>" >
								<input type="hidden" name="col_nam" value="id" >
								<input type="hidden" name="loc" value="departments.php" >
